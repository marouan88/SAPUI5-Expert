  ...
  namespace landvisz {
    namespace internal {
      interface $ActionBarSettings extends sap.ui.core.$ControlSettings {
         ...
         * label for action
         */
        actionLabel?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
         ...
         */
        actionTooltip?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $EntityActionSettings extends sap.ui.core.$ControlSettings {
         ...
         * rendering size of the control
         */
        renderingSize?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $EntityCustomActionSettings
         ...
         */
        customAction?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $HeaderListSettings extends sap.ui.core.$ControlSettings {
         ...
         * ToolTip for headers
         */
        headerTooltip?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

        /**
         * Size of the headers
         */
        entitySize?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $IdentificationBarSettings
         ...
         */
        qualifierText?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
         ...
         */
        qualifierType?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
         ...
         */
        defaultState?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $LinearRowFieldSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        iconType?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

        /**
         * title of the icon displayed in the row field
         */
        iconTitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

        /**
         * Image source of the icon on right
         */
        rightIconSrc?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

        /**
         * source from which two or more systems are dependent
         */
        linkSource?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $ModelingStatusSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        statusTooltip?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

        /**
         * icon source for status
         */
        stateIconSrc?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $NestedRowFieldSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        valueType?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $TreeFieldSettings extends sap.ui.core.$ControlSettings {
         ...
         * binding name
         */
        bindingName?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      class DeploymentType extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.landvisz.internal.$DeploymentTypeSettings
        );
        /**
         * Constructor for a new internal/DeploymentType.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.landvisz.internal.DeploymentType>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class LinearRowField extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.landvisz.internal.$LinearRowFieldSettings
        );
        /**
         * Constructor for a new internal/LinearRowField.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.landvisz.internal.LinearRowField>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class ModelingStatus extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.landvisz.internal.$ModelingStatusSettings
        );
        /**
         * Constructor for a new internal/ModelingStatus.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.landvisz.internal.ModelingStatus>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class NestedRowField extends sap.ui.core.Control {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.landvisz.internal.NestedRowField>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class TreeField extends sap.ui.core.Control {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.landvisz.internal.TreeField>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
    ...
    interface $ConnectionEntitySettings extends sap.ui.core.$ControlSettings {
       ...
       */
      connectionId?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       */
      linkId?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

      /**
       * link header data that is shared with in the entities
       */
      linkedHeader?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    ...
    interface $LandscapeEntitySettings extends sap.ui.core.$ControlSettings {
       ...
       */
      qualifierTooltip?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       * System entity ID
       */
      systemId?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       */
      stateIconTooltip?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       */
      trackSystemCount?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    ...
    interface $LandscapeViewerSettings extends sap.landvisz.$OptionSettings {
       ...
       */
      navigationPath?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    ...
    interface $OptionSettings extends sap.ui.core.$ControlSettings {
       ...
       */
      currentEntity?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    ...
    class ConnectionEntity extends sap.ui.core.Control {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.landvisz.ConnectionEntity>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Connector extends sap.ui.core.Control {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.landvisz.$ConnectorSettings
      );
      /**
       * Constructor for a new Connector.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.landvisz.Connector>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class LongTextField extends sap.ui.core.Control {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.landvisz.$LongTextFieldSettings
      );
      /**
       * Constructor for a new LongTextField.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.landvisz.LongTextField>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Option extends sap.ui.core.Control {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.landvisz.Option>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class OptionSource extends sap.ui.core.Control {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.landvisz.$OptionSourceSettings
      );
      /**
       * Constructor for a new OptionSource.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.landvisz.OptionSource>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
